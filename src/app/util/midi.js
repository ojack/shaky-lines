...
const transposeTable = require('./transpose.js')

module.exports = function Midi (client) {
  this.mode = 0
  this.isClock = false
  ...
  this.trigger = function (item, down) {
   ...
   // const transposed = this.transposeNumber(item.note, item.octave)
   ...
   const channel = item.channel
    ...
    console.log('sending', transposed,item, [c, n, v] )
    if (!n || c === 127) { return }
  ...
  //@oj mod
  this.play =  function (channel, octave, note, velocity, length, isPlayed = false) {
  ...
  this.transposeNumber = function (n, o = 3) {
