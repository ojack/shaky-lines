...
module.exports = function mainView (state, emit) {
    return html`
      <div class="w-100 h-100 fixed absolute courier flex flex-column flex-row-ns" style="background-color:${state.style.color0};color:${state.style.color1}">
        ...
        <div class="absolute bottom-0 right-0 ma4" style="${state.panels.editor?'opacity:1;pointer-events:all;':'opacity:0;pointer-events:none'};box-shadow: 2px 2px 6px 6px rgba(40, 40, 40, 0.3);background-color:${state.style.color0}; width: ${state.flok.enabled ? 300 : 450}px;transition:opacity 0.5s;"> 
